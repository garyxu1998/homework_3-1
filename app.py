...
app.layout = html.Div([
    ...
    html.Div(
        dcc.RadioItems(['True', 'False'], 'True', id='useRTH_input')
    ),
    ...
    html.Div(
        children=[
            html.Div(
                children=[
                    html.Label('Date:'),
                    dcc.DatePickerSingle(date='02/01/2022', id='edt-date')
                ],
                style={
            ...
            html.Div(
                children=[
                    html.Label('Hour:'),
                    dcc.Dropdown(list(range(24)), 1, id='edt-hour'),
                ],
                style={
                    'display': 'inline-block',
                    'padding-right': '5px'
            ...
            html.Div(
                children=[
                    html.Label('Minute:'),
                    dcc.Dropdown(list(range(60)), 0, id='edt-minute'),
                ],
                style={
                    'display': 'inline-block',
                    'padding-right': '5px'
            ...
            html.Div(
                children=[
                    html.Label('Second:'),
                    dcc.Dropdown(list(range(60)), 0, id='edt-second'),
                ],
...
@app.callback(
    ...
    [State('currency-input', 'value'),
     State('what-to-show', 'value'),
     State('edt-date', 'date'),
     State('edt-hour', 'value'),
     State('edt-minute', 'value'),
     State('edt-second', 'value'),
     State('durationStr_input', 'value'),
     State('barSizeSetting_input', 'value'),
     State('useRTH_input', 'value')]

)
def update_candlestick_graph(n_clicks, currency_string, what_to_show,
                             edt_date, edt_hour, edt_minute, edt_second,
                             durationStr_input, barSizeSetting_input, useRTH_input):
    # n_clicks doesn't
    ...
    print('durationStr_input=', durationStr_input, 'barSizeSetting_input=', barSizeSetting_input, 'useRTH=',
          (useRTH_input == 'True'))
